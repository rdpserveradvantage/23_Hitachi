...
--
-- Table structure for table `ai_cities`
--
...
--
-- Dumping data for table `ai_cities`
--

INSERT INTO `ai_cities` (`id`, `city`, `state_id`) VALUES
...
--
-- Indexes for table `ai_cities`
--
ALTER TABLE `ai_cities`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `ai_cities`
--
ALTER TABLE `ai_cities`

		...
		function set_Camera(atmid){
			...
			$.ajax({
				...
				success: (function (result) { debugger;
					...
					if(url_link=='https://192.168.100.23'){
						
					}else{
						//url_link = "https://103.141.218.26";
						//url_link = "https://comfort.ifiber.in";
						url_link = "https://103.141.218.146";
					}
		    ...
		    function setcamera(atmid){
				if(atmid=='P3ENMM09'){
				  var cam1 = "https://103.141.218.26:5020/?name=1";
				  $("#camera1").html('<iframe src="'+ cam1 + '" title="description" style="height: 350px;width: 100%;"></iframe>');
				 
				  $("#camera").html('<option value="">Select Camera</option><option value="https://103.141.218.26:5020/?name=2">Camera 2</option><option value="https://103.141.218.26:5020/?name=3">Camera 3</option><option value="https://103.141.218.26:5020/?name=4">Camera 4</option>');
				  $("#camurl_1").val("https://103.141.218.26:5020/?name=1");
				  $("#camurl_2").val("https://103.141.218.26:5020/?name=2");
				  $("#camurl_3").val("https://103.141.218.26:5020/?name=3");
				  $("#camurl_4").val("https://103.141.218.26:5020/?name=4");
				  setStopInterval(1);
				  $("#stop_camera1").css('display','block');
				  $('#startCamera1').css('display','block');
				  $('#stopCamera1').css('display','block');

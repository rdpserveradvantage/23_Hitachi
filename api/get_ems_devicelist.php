 ...
 date_default_timezone_set('Asia/Kolkata');
  ...
  function headersToArray( $str )
	...
	function get_AccessToken($refresh_token){
		$curl = curl_init();
    // https://eazyinfra.utopiatech.in:4510/user/accesstoken
		curl_setopt_array($curl, array(
	...
	function getAccessToken($refresh_token,$con){
		$curl = curl_init();
		//'https://eazyinfra.utopiatech.in:4510/user/login',
		curl_setopt_array($curl, array(
		  ...
		  CURLOPT_CUSTOMREQUEST => 'POST',
		  CURLOPT_SSL_VERIFYPEER => false,
		  CURLOPT_HEADER => true,   // email : api@pnbcts.com / pnb@123
		  CURLOPT_POSTFIELDS =>'{
...
$refresh_token = $ems_login_access['refresh_token'];
 //echo $org_id;
 // http://103.141.218.138  
$url = 'http://103.141.218.138:4510/panel/filterlist?org_id='.$org_id.'&group_id=0&state=All';

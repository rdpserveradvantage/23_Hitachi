    ...
    if($file_list[$i]=='AI_Feed'){
	 ...
	 // echo '<pre>';print_r($file_list_share);echo '</pre>';die;
	  for($j=0;$j<count($file_list_share);$j++){
		...
		//	$atmfile_list_share = ftp_nlist($ftp_conn,"AI_Feed/N3218600/2022_03_11/17");
//echo '<pre>';print_r($atmfile_list_share);echo '</pre>';die;

			//$atmfile_list_share = ftp_nlist($ftp_conn,"AI_Feed/D2142120/2022_04_24/14");
			//$atmfile_list_share = ftpRecursiveFileListing($ftp_conn,"D2142120");

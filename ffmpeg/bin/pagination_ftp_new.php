...
<?php $ftpmonth_array = ["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEPT","OCT","NOV","DEC"];
   ...
   <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
						...
						<div class="col-12 grid-margin"> <!-- (If search for today's video then select time 1 hour before from now.) -->
						   <h3 class="card-title">Videos </h3>
                            <div class="card">
                                <div class="card-body">
								   
                <!-- Page-Title -->
                                    <form method="POST" action="pagination_ftp_new.php">
									     <?php  //include('../../filters/sitehealth_filter.php'); 
										   include('../../filters/videoarchive_filter.php'); ?>
                                        <div class="row">
                                            <div class="col-md-2">  
											...
											<div class="col-md-4"> 
										       ...
										       <input id="merge_submit" type="submit" name="merge" value="Merge" class="btn btn-danger <?php if(isset($_POST['submit'])){ echo 'show'; }else{ echo 'hide';} ?>"  style="margin-top: 30px;">
										        <a href="https://103.141.218.26/ComfortTechnoNew/ffmpeg/bin/pagination_ftp.php" class="btn btn-info" style="margin-top: 30px;">Back</a>
											</div>
                                        </div>
                                    </form>
...
//echo 'From : '.$custfrom;echo '</br>';echo 'To:'.$custto;echo '</br>';
    $date_split = explode('_',$custdate);
	$mon_split_val = $date_split[1];
	$month_tbl = (int)$mon_split_val;
	
	$year = $date_split[0];
	$ftpmon = $ftpmonth_array[$month_tbl - 1];
	$ftp_root_fol = $ftpmon."_".$year;
...
//echo $count."_".$j;
	...
	if(is_array($checkfiles)){
		...
		if(in_array($j,$checkfiles)){
			...
			$fromimage_dir = $ftp_root_fol."/".$fromimage_dir;

...
if(!$site_sql || mysqli_num_rows($site_sql)==1){
	...
	if($panel_make == 'comfort' && $panel_status == 0){
												...
												foreach($keys as $value=>$key){
													if(startsWith ($key, 'zon')){ ?>
														 <td id="tdid<?php echo $count;?>">
															...
															<div 
															<?php 
															    if($panel_status==1){ echo "class='badge badge-danger badge-pill mb-2'"; } else { 
															     if(getrassstatus($key,$atmid,$con)=='0'){ echo "class='badge badge-success badge-pill mb-2'" ; }
															...
															<?php if($panel_status==1){ echo 'Not Working'; } else { if(getrassstatus($key,$atmid,$con)=='0'){ echo 'Working';}else{ echo 'Not Working'; } } ?>
															</div>
															<!--
															<p 

...
--
-- Host: localhost:3306
-- Generation Time: Apr 29, 2022 at 02:51 AM
...
CREATE TABLE `esurv_po_sites` (
  ...
  `client_approved_by` int(11) NOT NULL,
  `vendor_approved_by` int(11) NOT NULL,
  `is_completed` int(11) NOT NULL DEFAULT 0 COMMENT '0=pending,1=approved by vendor,2=approved by client',
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
